...
class LeaderboardEvaluator(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        self.manager = ScenarioManager(args.timeout, args.debug > 1, args.idAgent, np.random.randint(1000000))
...
def main():
    ...
    parser.add_argument('--timeout', default="350.0",
    ...
    parser.add_argument('--idAgent', type=int, default=0, help='ID agent in RLlib')
