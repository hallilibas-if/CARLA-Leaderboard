...
class ScenarioManager(object):
    ...
    def __init__(self, timeout, debug_mode=False, idAgent=0, key=0):
        """
    ...
    def run_scenario(self):
        ...
        self._running = True
        steps=0 #Shawan did it
        while self._running:
            if steps==self.ep_leng:
                break
            steps+=1
            timestamp = None
        ...
        print("Total steps per episode: ", steps)
    ...
    def _tick_scenario(self, timestamp):
        ...
        if self._timestamp_last_run < timestamp.elapsed_seconds and self._running:
            ...
            rewardS=self.scenario.get_criteria()
            try:
                ego_action = self._agent(rewardS, self.idAgent, self.key)
